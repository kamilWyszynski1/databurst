...
mod tests {
    ...
    /*
    (0) internal [root: true, parent: ] ([(7, 4)], key Pointer(6))
     (7) internal [root: false, parent: 0] ([(2, 2)], key Pointer(1))
      (2) leaf: [parent: 7](kvs: [1, 2], next_leaf: Some(Pointer(1)))
      (1) leaf: [parent: 7](kvs: [3, 4], next_leaf: Some(Pointer(3)))
     (6) internal [root: false, parent: 0] ([(3, 6), (4, 8), (5, 10)], key Pointer(8))
    ...
    (0) internal [root: true, parent: ] ([(7, 4), (8, 8)], key Pointer(10))
     (7) internal [root: false, parent: 0] ([(2, 2)], key Pointer(1))
      (2) leaf: [parent: 7](kvs: [1, 2], next_leaf: Some(Pointer(1)))
      (1) leaf: [parent: 7](kvs: [3, 4], next_leaf: Some(Pointer(3)))
     (6) internal [root: false, parent: 0] ([])
      (3) leaf: [parent: 6](kvs: [5, 6], next_leaf: Some(Pointer(4)))
      (4) leaf: [parent: 6](kvs: [7, 8], next_leaf: Some(Pointer(5)))
     (10) internal [root: false, parent: 0] ([(5, 10), (8, 12)], key Pointer(9))
